    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            fragment = document.importNode(templates.login, true);

            fragment.querySelector(".login__form").addEventListener("submit", function () {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 4;
                        return todoAPI.post("/users/login", payload);
        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            res.data.forEach(function (todos) {
              ...
              // 할 일 목록에서 삭제 
              fragment.querySelector(".todo-item__remove-btn").addEventListener("click", function () {
                  ...
                  return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          _context3.next = 2;
                          return todoAPI.delete("/todos/" + todos.id);
              ...
              // 할 일 완료
              fragment.querySelector('.todo-item__complete-btn').addEventListener('click', function () {
...
var todoAPI = _axios2.default.create({
  baseURL: "https://learned-iris.glitch.me"
});
